...
class CuboidDemoScreen extends StatefulWidget {
  CuboidDemoScreen({Key? key}) : super(key: key);

  @override
  State<CuboidDemoScreen> createState() => _CuboidDemoScreenState();
}

class _CuboidDemoScreenState extends State<CuboidDemoScreen> {
